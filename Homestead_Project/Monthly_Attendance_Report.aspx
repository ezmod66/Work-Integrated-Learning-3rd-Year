<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Monthly_Attendance_Report.aspx.cs" Inherits="Homestead_Project.Monthly_Attendance_Report" %>
...
<body style="background: url(leaf-background2.png) fixed;">
    ...
    <div class="main">
        <div class="hero-image">
			<h1 class="heading">Monthly Attendance Record</h1>
        </div>
        <form id="form1" runat="server">
            <div class="monthly-attendance-box" style="width:1200px">
                <div class="container">

             
                <div id="search">
					<asp:Label runat="server"  CssClass="labels" Text="Choose The Month you want to view the report for:"/>
					<asp:DropDownList ID="MonthCombo" runat="server" CssClass="combo-box" OnSelectedIndexChanged="MonthCombo_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <br />
                     ...
                     <asp:GridView ID="GridView1" ShowHeaderWhenEmpty="true" runat="server" AutoGenerateColumns="false" CssClass="gridview" Width="1200px" >
                        <Columns>
                            ...
                            <asp:BoundField DataField="datetime" HeaderText="Dates" />

                        </Columns>
                    </asp:GridView>
                    <br />
                    <asp:Label runat="server" Text="Click to view the Monthly Attendance Record for One Child" CssClass="labels" />
					<asp:Button runat="server" Text="View" CssClass="buttons" ID="viewAttendanceRecordPerChild" OnClick="viewAttendanceRecordPerChild_Click" />
               </div>
                    </form>
        </div>
